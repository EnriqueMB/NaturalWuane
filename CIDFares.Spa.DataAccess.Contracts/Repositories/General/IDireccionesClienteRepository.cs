...
{
    public interface IDireccionesClienteRepository: IBaseRepository<DireccionesCliente>
    {
        Task<IEnumerable<DireccionesClienteRequest>> GetDirecciones(object IdCliente);
    }
}
