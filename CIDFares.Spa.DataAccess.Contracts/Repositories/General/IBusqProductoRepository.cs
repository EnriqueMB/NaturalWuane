...
namespace CIDFares.Spa.DataAccess.Contracts.Repositories.General
{
    ...
    {
        Task<IEnumerable<BusqueProducto>> GetBusquedaProductoAsync(bool BitNombre, string BusqNombre, bool BitClaveCodigo, string BusqClaveCodigo, object IdSucursal);
    }
}
